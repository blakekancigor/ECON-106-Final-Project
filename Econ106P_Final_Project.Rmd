...
\textcolor{blue}{Using our demand elasticity estimate of -1.98 and the Nash-Bertrand pricing model, we calculated the Lerner Index for all airline data. The average and median Lerner Index are both 0.304, which means that airlines charge prices that are roughly 30 percent higher than their marginal cost.}
